<?php
	...
	if ($_GET['action'] == 'save'){
		...
		if ($download){
			...
			$download->publication_date = $_POST['publication_date'];
			$download->pages = $_POST['pages'];
			$download->remarks = $_POST['remarks'];
			$download->status = $_POST['status'];
			$download->download_id = $_POST['download_id'];
			$download->code = $_POST['code'];
			$download->job_number = $_POST['job_number'];
			$download->add_download();
